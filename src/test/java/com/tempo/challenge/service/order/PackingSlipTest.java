...
import com.tempo.challenge.service.order.PackingSlip;
...
public class PackingSlipTest {
	...
	public void shouldProcessWhenPhisicalProduct() {
		...
		boolean shouldProcess = packingSlip.shouldProcess(order);
	...
	public void shouldProcessAndNextProcessWhenPastNextProcess() {
		...
		PackingSlip packingSlip = new PackingSlip();
		packingSlip.setNextProcess(this.activateMemberShip);
		packingSlip.process(order);
